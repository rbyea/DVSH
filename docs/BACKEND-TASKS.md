...
### 1.3 [Н] Профиль СТО: телефон, город, адрес, график
...
### 1.4 [Н] Диагностика сканера на карточке авто
...
### 1.5 [Н] Согласование при `pending_approval` без `estimate_status`
...
### 1.6 [Н] Статус `revision` после отказа клиента
...
3. **1.3** контакты СТО
4. **Блок 3** — сделать всё, чего ещё нет (фронт готов)
5. **1.4** диагностика сканера — не блокер выдачи
6. **4.1** — по готовности к выдаче в СТО
